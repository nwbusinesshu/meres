<?php
return [
  "user-console-warning" => "⚠️ ⚠️ ⚠️\\nEz a böngészőfunkció fejlesztőknek van fenntartva! Kérjük a saját fiókjának biztonsága érdekében, semmilyen harmadik féltől származó tartalmat ne másoljon be ide!\\n⚠️ ⚠️ ⚠️",

  "404" => "Ez az oldal nem létezik!",

  "403" => "Ehhez az oldalhoz nincs jogosultsága!",

  "419" => "Munkamenete lejárt! Jelentkezzen be újra.",
  ...
  "swal-database-error" => "Adatbázis hiba!",
  ...
  "text-copied" => "Szöveg vágólapra másolva!",
...
'cookie_preferences_saved' => 'Cookie preferences saved successfully',
  ...
  'position' => 'Beosztás',
  'theme-toggle-title' => 'Világos/Sötét téma váltás',
'theme-toggle-aria' => 'Téma váltása',
'tax-number-label' => 'Adószám:',
  'eu-vat-number-label' => 'EU adószám:',
  'billing-address-label' => 'Számlázási cím:',
  'subscription-label' => 'Előfizetés:',
  'not-provided' => 'Nincs megadva',
  'delete-failed' => 'Nem sikerült törölni.',
  'fetch-org-data-failed' => 'Nem sikerült lekérni a cég adatait.',
