...
@endif
   ...
   @if(app()->environment('production'))
        ...
        <script>
            ...
            window['barion_pixel_id'] = 'BP-6GANnwjFQ6-28';            
        ...
        <noscript>
            <img height="1" width="1" style="display:none" alt="Barion Pixel" src="https://pixel.barion.com/a.gif?ba_pixel_id='BP-6GANnwjFQ6-28'&ev=contentView&noscript=1">
        </noscript>
        @endif
