...
<div class="fixed-row">
  ...
  <div class="tile tile-button create-competency"><span><i class="fa fa-circle-plus"></i>{{ $_('create-competency') }}</span></div>
</div>
...
@endforeach
<div class="no-competency @if(!$competencies->isEmpty()) hidden @endif"><p>{{ $_('no-competency') }}</p></div>
</div>
