...
<div class="tile register-tile">
  ...
  <form id="register-form" method="POST" action="{{ route('register.perform') }}" class="w-100" style="max-width:640px;margin:0 auto;">
    @csrf

    {{-- STEP 1 – Admin --}}
    <section class="reg-step" data-step="1">
      ...
      <div class="step-actions">
        <button type="button" class="btn btn-primary btn-block next-step">Tovább</button>
      </div>
  ...
  <option value="US">USA (US)</option>
      ...
      <div class="form-row two">
        <div class="form-group non-eu-only">
          <label>Adószám (HU: 12345678-1-12)</label>
          <input type="text" name="tax_number" class="form-control">
        </div>
        <div class="form-group eu-only">
          <label>EU ÁFA-szám (pl. DE123456789)</label>
          <input type="text" name="eu_vat_number" class="form-control">
        </div>
      </div>
    ...
    <section class="reg-step" data-step="3" hidden>
      ...
      <div class="tile tile-info inner">
        <div class="text">
          ...
          <div class="meta">Telemetria és AI segédfunkciók bekapcsolása. A Strict Anon. mód nélkül használható. (Később módosítható a beállításokban.)</div>
        </div>
        <label class="switch">
      ...
      <div class="tile tile-info inner">
        <div class="text">
          ...
          <div class="meta">A besorolások láthatóságának kapcsolója a felhasználói felületen.</div>
        </div>
        <label class="switch">
    ...
    {{-- STEP 4 – Összegzés --}}
    <section class="reg-step" data-step="4" hidden>
      <h3>Összegzés</h3>
      <div class="summary">
        <!-- JS tölti fel -->
      </div>
  ...
  <div class="text-center my-3" style="opacity:.7;"></div>

  <div class="footnote">
    Már van fiókod? <a href="{{ route('login') }}">Bejelentkezés</a>
  </div>
